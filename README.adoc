...
Launching defaultServer (Open Liberty 20.0.0.6/wlp-1.0.41.cl200620200528-0414) on OpenJDK 64-Bit Server VM, version 11.0.3+7 (en_CA)
...
[INFO    ] CWWKZ0134I: The guide-arquillian-managed application is using the loose application definition at the guide-arquillian-managed/finish/target/liberty/wlp/usr/servers/defaultServer/apps/guide-arquillian-managed.war.xml location.
...
[INFO    ] SESN0172I: The session manager is using the Java default SecureRandom implementation for session ID generation.
[AUDIT   ] CWWKZ0001I: Application arquillian-managed started in 0.445 seconds.
[INFO    ] SRVE9103I: A configuration file for a web server plugin was automatically generated for this server at guide-arquillian-managed/finish/target/liberty/wlp/usr/servers/defaultServer/logs/state/plugin-cfg.xml.
...
[INFO    ] SRVE0253I: [arquillian-managed] [/arquillian-managed] [io.openliberty.guides.system.SystemApplication]: Destroy successful.
...
[INFO    ] SESN0176I: A new session context will be created for application key default_host/arquillian-managed
[INFO    ] SESN0172I: The session manager is using the Java default SecureRandom implementation for session ID generation.
[AUDIT   ] CWWKZ0001I: Application arquillian-managed started in 0.366 seconds.
[INFO    ] SRVE9103I: A configuration file for a web server plugin was automatically generated for this server at guide-arquillian-managed/finish/target/liberty/wlp/usr/servers/defaultServer/logs/state/plugin-cfg.xml.
...
[AUDIT   ] CWWKE0055I: Server shutdown requested on Tuesday, June 23, 2020 at 12:40 p.m.. The server defaultServer is shutting down.
...
[INFO    ] SRVE0253I: [guide-arquillian-managed] [/] [io.openliberty.guides.system.SystemApplication]: Destroy successful.
[AUDIT   ] CWWKZ0009I: The application guide-arquillian-managed has stopped successfully.
[AUDIT   ] CWWKE0036I: The server defaultServer stopped after 9.339 seconds.
