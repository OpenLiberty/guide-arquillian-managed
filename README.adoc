...
Run the following commands in the `start` directory to package the application. Then,
use the `liberty-maven-plugin` goals to create the application server, install the features
