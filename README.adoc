...
The test cases are ready to run. You will configure the Maven build and the Liberty's configuration to run them.
...
=== Configuring the Liberty server.xml configuration file
