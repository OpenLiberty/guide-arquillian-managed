...
You need the [hotspot=115-121]`arquillian-liberty-managed-junit` dependency bundle,
which includes all the core dependencies for running Arquillian tests on a
...
You also need the [hotspot=122-126]`shrinkwrap-api` dependency.
