...
see the https://github.com/OpenLiberty/liberty-arquillian/blob/master/liberty-managed/README.md#configuration[Arquillian Liberty Managed documentation^].
...
You can learn more about this goal in the https://github.com/WASdev/ci.maven/blob/master/docs/configure-arquillian.md[configure-arquillian goal documentation^].
