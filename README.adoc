...
Configure your build to use the Arquillian Liberty Managed container and set up your Open Liberty instance to run your test cases by configuring the `server.xml` file.
...
Now that you're done configuring your Maven build, set up your Open Liberty instance to run your test cases by configuring the [hotspot]`server.xml` file.
